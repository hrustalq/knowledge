...
Design docs for the features listed in `features.md` (root). Each document
describes the feature's scope, API surface, data-model changes, frontend work
and what was deliberately deferred. `plan.md` stays the authoritative
architecture document; these docs cover the product-feature layer on top of it.
...
| 27  | Codebase connector (docs from source)      | [features/27-codebase-connector.md](features/27-codebase-connector.md)   | ✅ implemented               |
